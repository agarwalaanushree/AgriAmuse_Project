...
class _PredictionState extends State<Prediction> {
  ...
  List<DropdownMenuItem<String>> get dropdownDistrict {
    List<DropdownMenuItem<String>> menuItems = [
      ...
      DropdownMenuItem(
          child: Text("NORTH AND MIDDLE ANDAMAN"),
  ...
  List<DropdownMenuItem<String>> get dropdownCrop {
    List<DropdownMenuItem<String>> menuItems = [
      ...
      DropdownMenuItem(
          child: Text("Beans & Mutter(Vegetable)"),
      ...
      DropdownMenuItem(
          child: Text("Moong(Green Gram)"), value: "Moong(Green Gram)"),
      ...
      DropdownMenuItem(
          child: Text("Other  Rabi pulses"), value: "Other  Rabi pulses"),
      DropdownMenuItem(
          child: Text("Other Fresh Fruits"), value: "Other Fresh Fruits"),
      DropdownMenuItem(
          child: Text("Other Kharif pulses"), value: "Other Kharif pulses"),
      DropdownMenuItem(
          child: Text("Other Vegetables"), value: "Other Vegetables"),
      DropdownMenuItem(child: Text("Papaya"), value: "Papaya"),
      DropdownMenuItem(
          child: Text("Peas  (vegetable)"), value: "Peas  (vegetable)"),
      ...
      DropdownMenuItem(
          child: Text("Rapeseed &Mustard"), value: "Rapeseed &Mustard"),
      ...
      DropdownMenuItem(
          child: Text("other misc. pulses"), value: "other misc. pulses"),
  ...
  Map cropMap = {
    ...
    'Other Fresh Fruits': 40,
    'Other Kharif pulses': 41,
    'Other Vegetables': 42,
    'Papaya': 43,
    'Peas  (vegetable)': 44,
    'Pome Fruit': 45,
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                showYield
                    ? Text("Expected Yield is : ${expectedYield}",
