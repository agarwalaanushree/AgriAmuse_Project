...
class SoilCard extends StatelessWidget {
  ...
  List<Detail> details = [
    Detail(
      ...
      photo: 'assets/images/alluvial.png',
    ),
    Detail(
      name: 'Black Soil',
      about:
    ...
    Detail(
      ...
      photo: 'assets/images/red-yellow.png',
    ),
    Detail(
      name: 'Laterite Soil',
      about:
      ...
      photo: 'assets/images/laterite.png',
    ),
    Detail(
      name: 'Arid Soil',
      about:
    ...
    Detail(
      ...
      photo: 'assets/images/mountain.png',
    ),
    Detail(
      name: 'Desert Soil',
      about:
      ...
      photo: 'assets/images/desert.png',
    )
  ];
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Card(
        ...
        color: Color.fromARGB(255, 120, 229, 124),
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DetailPage(detail: details[soil.index]),
              ),
            );
          },
          child: Column(
